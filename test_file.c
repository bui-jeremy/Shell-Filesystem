/*
   ...
   The use of this file is permitted only for classroom purposes.
   Public distribution of this file, or its contents in part, is strictly
   forbidden. Violators will be subjected to forty two hours of listening
   to Vogon poetry! 
...
int main () {
  ...
  while ((retval = READDIR (fd, addr))) { /* 0 indicates end-of-file */
    ...
    index_node_number = ((short *)(&addr[14]))[0];
